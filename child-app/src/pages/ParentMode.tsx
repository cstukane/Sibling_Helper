        ...
        <section>
          ...
          <div style={{ marginTop: 32 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12 }}>
              {quests.filter(q => getQuestType(q) === 'quest').map(quest => (
                <div 
                  key={quest.id} 
                  style={{ 
                    padding: 12, 
      ...
      {activeTab === 'chores' && (
        <section>
          ...
          <div style={{ marginTop: 32 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12 }}>
              {quests.filter(q => getQuestType(q) === 'chore').map(quest => (
                <div 
                  key={quest.id} 
                  style={{ 
                    padding: 12, 
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <div>
                  <div style={{ fontWeight: 'bold' }}>Theme Mode</div>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <button
                    ...
                    style={{ 
                      ...
                      border: '1px solid #ddd',
                      borderRadius: 4,
                      background: themeMode === 'light' ? '#0ea5e9' : 'white',
                  ...
                  <button
                    ...
                    style={{ 
                      ...
                      border: '1px solid #ddd',
                      borderRadius: 4,
                      background: themeMode === 'dark' ? '#0ea5e9' : 'white',
