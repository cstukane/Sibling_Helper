...
import { PointRequestApprovalPanel } from '@sibling-helper/shared';
...
const ParentMode: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'quests' | 'chores' | 'rewards' | 'requests' | 'settings'>('profile');
  ...
  return (
    <div style={{ 
      ...
      {activeTab === 'quests' && (
        <section>
          <h2 style={{ color: isDarkMode ? '#f8fafc' : '#000000' }}>Manage Quests</h2>
          ...
          <div style={{ marginTop: 32 }}>
            <h3 style={{ color: isDarkMode ? '#f8fafc' : '#000000' }}>Existing Quests</h3>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12 }}>
              {quests.filter(q => q.category !== 'chores').map(quest => (
                ...
                >
                  <div>
                    <strong style={{ color: isDarkMode ? '#f8fafc' : '#000000' }}>{quest.title}</strong>
      ...
      {activeTab === 'chores' && (
        <section>
          <h2 style={{ color: isDarkMode ? '#f8fafc' : '#000000' }}>Manage Chores</h2>
      ...
      {activeTab === 'rewards' && (
        <section>
          <h2 style={{ color: isDarkMode ? '#f8fafc' : '#000000' }}>Manage Rewards</h2>
